...
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.1 SSS Overall mean of TEP from  1998 to 2020" }
## ==============================================================
...
SSS_POT=brick("SSS_POT_1998-2020.nc")# los datos menseuales del POT comienzan en enero 1998 hasta diciembre 2019 
SSS_POT
...
##Overall mean
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.3 Kd480 Overall mean of TEP from  1998 to 2020"}
#Open monthly record of SSS 
...
```
## Overal SD 
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.4 Kd480 Overall SD of TEP from  1998 to 2020"}
...
## Overall mean
<p>
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.5 Chlorophyll a Overall mean of TEP from  1998 to 2020"}
...
```
## Overall SD
```{r fig.align="center", fig.cap="Fig 6. Chlorophyll a Overall SD of TEP from  1998 to 2020",fig.height=4, fig.width=8}
...
## Overall mean
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.7 pH Overall mean of TEP from  1998 to 2020"}
...
```
## Overall SD
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.8 pH Overall SD of TEP from  1998 to 2020"}
...
<p>For sea current velocity there is a preliminary step to take into account before calculating mean and standard deviation.CMEMS provides information on sea current velocity in two separate datasets: eastward velocity and northward velocity. These two datasets represent, respectively, the water movement toward east and toward north.</p> 
<hr>
...
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.9 Overall water velocity of TEP from 1998 to 2020"}
POT_SCV = sqrt(POT_EWV^2+POT_NWV^2)
POT_EWV
```
## Overall mean
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.10 overall water velocity Mean"}
#Calculate de overall mean
...
```
## Overall SD
```{r, warning=FALSE, message=FALSE,fig.align="center", fig.width=8, fig.height=4, fig.cap="Fig.11 Overall water velocity SD"}
