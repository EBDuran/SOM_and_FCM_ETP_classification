# Performing an Eastern Tropical Pacific Physicochemical Classification using Two Methods: Self-Organizing Maps (SOM) and Fuzzy c-means 
...
### d) Selection of Optimal Clusters Using GAP 
